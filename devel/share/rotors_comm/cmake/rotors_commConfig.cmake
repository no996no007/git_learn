...
if("TRUE" STREQUAL "TRUE")
  set(rotors_comm_SOURCE_PREFIX /home/tao/no996/src/CICRSIM-master/rotors_simulator/rotors_comm)
  set(rotors_comm_DEVEL_PREFIX /home/tao/no996/devel)
  ...
  set(rotors_comm_INSTALL_PREFIX /home/tao/no996/install)
...
if(NOT "/home/tao/no996/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_comm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tao/no996/src/CICRSIM-master/rotors_simulator/rotors_comm/${idir}'.  ${_report}")
    endif()
