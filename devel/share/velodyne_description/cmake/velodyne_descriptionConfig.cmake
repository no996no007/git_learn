...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_description_SOURCE_PREFIX /home/tao/no996/src/CICRSIM-master/velodyne_simulator/velodyne_description)
  set(velodyne_description_DEVEL_PREFIX /home/tao/no996/devel)
  ...
  set(velodyne_description_INSTALL_PREFIX /home/tao/no996/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tao/no996/src/CICRSIM-master/velodyne_simulator/velodyne_description/${idir}'.  ${_report}")
    endif()
