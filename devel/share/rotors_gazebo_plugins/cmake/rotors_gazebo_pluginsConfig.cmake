...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/tao/git_test/git_learn/src/CICRSIM/rotors_simulator/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/tao/git_test/git_learn/devel)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/tao/git_test/git_learn/install)
...
if(NOT "/home/tao/git_test/git_learn/src/CICRSIM/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/include/opencv4 " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/tao/git_test/git_learn/src/CICRSIM/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tao/git_test/git_learn/src/CICRSIM/rotors_simulator/rotors_gazebo_plugins/${idir}'.  ${_report}")
    endif()
...
set(depends "cv_bridge;geometry_msgs;mav_msgs;rosbag;roscpp;gazebo_plugins;rotors_comm;std_srvs;tf")
